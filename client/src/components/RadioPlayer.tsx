...
export const RadioPlayer: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-5 left-5 z-50 transition-all duration-300">
      ...
      {isOpen ? (
        <div className="w-80 sm:w-96 glass-morphism rounded-2xl p-4 border border-[#39FF14]/40 shadow-[0_0_25px_rgba(57,255,20,0.25)] animate-in fade-in slide-in-from-bottom-5 duration-200">
          {/* Header */}
